...
type
  ...
  TImageGridItemList = array[0..MaxListSize div 4] of TImageGridItem;
...
function TBorderControl.Canvas: TCanvas;
begin
...
procedure TCustomImageGrid.FontChanged(Sender: TObject);
begin
  Invalidate;
end;
...
procedure TCustomImageGrid.SetCaptionFont(const Value: TFont);
begin
...
procedure TCustomImageGrid.SetDetailFont(const Value: TFont);
begin
...
procedure Register;
begin
  RegisterComponents('JD Components', [TImageGrid]);
end;
